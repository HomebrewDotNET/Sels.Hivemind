...
{
    /// <summary>
    /// Options for configuring the setting for retrying failed jobs.
    /// </summary>
    public class JobRetryOptions
    {
        ...
        // Properties
        /// <summary>
        /// The maximum amount of times a job can be retried.
        /// </summary>
        ...
        /// <summary>
        /// Contains the validation rules for <see cref="JobRetryOptions"/>.
        /// </summary>
        public class JobRetryOptionsValidationProfile : ValidationProfile<string>
        {
            /// <inheritdoc cref="JobRetryOptionsValidationProfile"/>
            public JobRetryOptionsValidationProfile()
            {
                CreateValidationFor<JobRetryOptions>()
