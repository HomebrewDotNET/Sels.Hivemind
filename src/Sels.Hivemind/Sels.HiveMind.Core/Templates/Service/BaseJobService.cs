...
namespace Sels.HiveMind.Templates.Service
{
    ...
    /// </summary>
    public abstract class BaseJobService : BaseService
    {
        // Fields
        ...
        protected BaseJobService(IOptionsMonitor<HiveMindOptions> options, IMemoryCache cache, ILogger? logger = null) : base(options, cache, logger)
        {
        }
