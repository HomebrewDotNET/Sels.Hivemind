...
namespace Sels.HiveMind.Colony
{
    ...
    {
        /// <inheritdoc/>
        public Task<IActivatorScope> CreateActivatorScopeAsync(IServiceProvider serviceProvider, CancellationToken cancellationToken = default)
        {
    ...
    public class ServiceProviderActivatorScope : IActivatorScope
    {
        ...
        /// <inheritdoc/>
        public Task<object> ActivateAsync(Type type, CancellationToken cancellationToken = default)
        {
